      ...
      <main className="max-w-6xl m-auto h-[95vh] flex justify-center">
        <div className="flex gap-28 w-full items-center justify-center">
          ...
          <div className="flex flex-col py-8 gap-2 w-96 h-[25rem] shadow-md border rounded-md">
            <h3 className="px-8 text-base font-bold text-black">
              Bem-vindo de volta 👋
            </h3>
            ...
            <div className="flex flex-col gap-4 w-full">
              <form className="flex flex-col gap-6 px-8 items-center">
                <input
                  ...
                  className="w-full text-xs bg-gray-100 p-2 rounded-md border"
                />
                <input
                  type="password"
                  name="password"
                  id="password"
                  placeholder="Insira a sua password aqui"
                  className="w-full text-xs bg-gray-100 p-2 rounded-md border"
                />
                  ...
                  <div className="w-full inline-flex justify-between">
                    <div className="flex gap-1 items-center">
                      <input
                        ...
                        id=""
                      />
                      <p className="text-xs">Lembre-se de mim</p>
                    </div>
                ...
                <p className="text-xs">
                  Não tem uma conta?{" "}
                  <Link href="signup">
                    <span className="text-teal-900">Inscreva-se</span>
                  </Link>
                </p>
              </form>
            </div>
