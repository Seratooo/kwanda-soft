...
export function EmployeesTableComponent() {
  return (
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between border-b py-5">
                      <div className="flex w-1/2 flex-col">
                        ...
                        <p className="font-medium text-sm">{employee.status}</p>
                      </div>
                      <div className="flex w-1/2 flex-col">
                        ...
                        <p
                          className={clsx("p-1 rounded font-medium text-sm", {
                            "bg-[#E5241D] text-white":
                              "emergência" == employee.priority,
                            "bg-[#F49825] text-white":
                              "muito-urgente" == employee.priority,
                            "bg-[#FDCC37] text-white":
                              "urgente" == employee.priority,
                            "bg-[#4CAE3F] text-white":
                              "pouco-urgente" == employee.priority,
                            "bg-[#3E4999] text-white":
                              "não-urgente" == employee.priority,
                          })}
                        >
                          {employee.priority}
                        </p>
